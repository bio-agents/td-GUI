...
class TdguiProxy
	...
	OLD_DBFETCH_URL = 'http://www.ebi.ac.uk/Agents/dbfetch/dbfetch/uniprotkb/xxxx/uniprotxml'
	...
	DBFETCH_URL = 'http://www.ebi.ac.uk/Agents/dbfetch/dbfetch?db=uniprotkb&id=xxxx&format=xml'
