...
function getPanelWithAgentbars () {
    /**
     * Agentbar with a menu
     */
    ...
    return {
        ...
        title: 'Basic Panel With Agentbars',
        collapsible: true,

        tbar: {
            id: 'panelWithAgentbars_tbar',
            items: [{
                xtype: 'buttongroup',
                title: 'Button Group',
                id: 'panelWithAgentbars_btngroup',
                columns: 2,
                defaults: {
                    scale: 'small'
                },
                items: [
                    ...
                    },
                    {
                        ...
                        text: 'Cut',
                        iconCls: 'icon-cancel',
                        id: 'panelWithAgentbars_splitbtn',
        ...
        lbar: {
            id: 'panelWithAgentbars_lbar',
            items: [
                { text: 'Left' }
            ]
        },
        rbar: {
            id: 'panelWithAgentbars_rbar',
            items: [
                { text: 'Right' }
            ]
        }
    ...
    return {
        ...
        items: [
            ...
            },
            {
                ...
                name        : 'html',
                enableColors: false,
                value       : 'Mouse over agentbar for agenttips.<br /><br />The HTMLEditor IFrame requires a refresh between a stylesheet switch to get accurate colors.',
                height      : 110
            },
            {
                xtype : 'fieldset',
...
function getGrid () {
    var store = getStore(),
        pagingBar = Ext.createWidget('pagingagentbar', {
            store      : store,
            displayInfo: true,
