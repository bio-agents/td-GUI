...
//    
      __x.player = Ext.create('Ext.ux.event.Player', {
             eventQueue: [{
                 cmpQuery: 'panel[title="Collapsed Panel"] > header > agent[type=expand-bottom]',
                ...
                cmpQuery: 'panel[title="Collapsed Panel"] > header > agent[type=collapse-top]',
                 ...
                 cmpQuery: 'panel[title="Masked Panel"] > header > agent[type=collapse-top]',
                 ...
                 cmpQuery: 'panel[title="Masked Panel"] > header > agent[type=collapse-bottom]',
                ...
                cmpQuery: 'panel[title="Collapsed Framed Panel"] > header > agent[type=expand-bottom]',
                ...
                cmpQuery: 'panel[title="Collapsed Framed Panel"] > header > agent[type=collapse-top]',
                ...
                cmpQuery: 'window[title=Window] > agentbar > button[text=Submit]',
                ...
                cmpQuery: 'window[title=Window] > header > agent[type=collapse-top]',
                ...
                cmpQuery: 'window[title=Window] > header > agent[type=collapse-bottom]',
                ...
                cmpQuery: 'panel[title=Basic Panel With Agentbars] > agentbar[dock=top] > buttongroup > button[text=Menu Button]',
                ...
                cmpQuery: 'panel[title=Basic Panel With Agentbars] > agentbar[dock=top] > buttongroup > button[text=Cut]',
                ...
                cmpQuery: 'panel[title=Basic Panel With Agentbars] > agentbar[dock=bottom] > button[text=Menu Button]',
                ...
                cmpQuery: 'panel[title=Basic Panel With Agentbars] > agentbar[dock=bottom] > button[text=Split Button]',
                ...
                cmpQuery: 'panel[title=Basic Panel With Agentbars] > agentbar[dock=bottom] > button[text=Toggle Button]',
