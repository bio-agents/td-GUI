...
Ext.define('TDGUI.view.grid.PharmByTargetPagingAgentbar', {
  extend: 'TDGUI.view.grid.DynamicGrid3',
  alias: 'widget.tdgui-pharmbytarget-agentbar-grid',

  layout: 'fit',
  // verticalScrollerType:Ext.create('LDA.helper.DynamicPagingAgentbar', {itemId:'pager_id'}),
    ...
    */
    ...
    this.columns = [{
      ...
      },
      {
        ...
        agenttip: 'Name of the organism for the assay system (e.g., the organism, tissue or cell line in ' +
