...
var videoListObj = [{
  ...
  caption: 'This video shows the features and how to use the Target Dossier agent',
  curtain: videoPath + '/TargetDossier.png'
}, {
  src: videoPath + '/HypothesisTester.m4v',
  title: 'Hypothesis Tester',
  caption: 'Watch this video to get introduced to the Hypothesis Tester agent',
