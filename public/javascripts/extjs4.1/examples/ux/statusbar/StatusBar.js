/**
 * Basic status bar component that can be used as the bottom agentbar of any {@link Ext.Panel}.  In addition to
 * supporting the standard {@link Ext.agentbar.Agentbar} interface for adding buttons, menus and other items, the StatusBar
...
Ext.define('Ext.ux.statusbar.StatusBar', {
    extend: 'Ext.agentbar.Agentbar',
    alternateClassName: 'Ext.ux.StatusBar',
    alias: 'widget.statusbar',
    requires: ['Ext.agentbar.TextItem'],
    /**
     * @cfg {String} statusAlign
     * The alignment of the status element within the overall StatusBar layout.  When the StatusBar is rendered,
     * it creates an internal div containing the status text and icon.  Any additional Agentbar items added in the
     ...
     *     // exact same agentbar, except the status and agentbar item
     ...
     * will be set as innerHTML (html tags are accepted) for the agentbar item.
     ...
     * the agentbar using an empty string (`''`) for this value would end up in the agentbar
     * height collapsing since the empty string will not maintain the agentbar height.
     * Use `''` if the agentbar should collapse in height vertically when no text is
     * specified and there are no other items in the agentbar.
     */
    emptyText : '&#160;',
    ...
    initComponent : function(){
        ...
        this.statusEl = Ext.create('Ext.agentbar.TextItem', {
