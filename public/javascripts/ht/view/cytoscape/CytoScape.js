...
// EO PROCEDURE FOR JOINING TWO NODES /////////////
			...
			me.vis.addListener('mouseover', 'nodes', function(ev) {
				...
				var myTip = Ext.create('Ext.tip.AgentTip', {
					html: tipMsg,
					width: 200,
					dismissDelay: 1000
				});
      ...
      */
			...
			me.vis["customAgenttip"] = function (data) {
...
//    the custom mapper to one or more visual properties:
			...
			style.nodes.agenttipText = { customMapper: { functionName: "customAgenttip" } },

// 3. Finally set the visual style again:
			me.vis.visualStyle(style);
			me.vis.nodeAgenttipsEnabled(false);
/*
			var nodeOne = {
					id: '3',
					label: 'Tres',
